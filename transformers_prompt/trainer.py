...
class Trainer:
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        inputs['input_features'].requires_grad=True
        # print(inputs)
    ...
    def evaluation_loop(
        ...
        if self.compute_metrics is not None and all_preds is not None and all_labels is not None:
            if args.include_inputs_for_metrics:
                ...
                metrics = self.compute_metrics(EvalPrediction(predictions=all_preds, label_ids=all_labels), args, prompts)
        else:
            metrics = {}
